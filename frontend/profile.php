...
$pageTitle = "Profile - Soudemy";
include 'includes/header.php';

// Database connection and get user information
            ...
            <div class="profile-sidebar">
                <div class="user-card">
                    <div class="user-avatar">
                        <?php 
                        // Check and display avatar correctly
...
<div class="avatar-placeholder" <?php if (!empty($user['avatar']) && file_exists('../' . $user['avatar'])) echo 'style="display:none;"'; ?>>
    <i class="fa fa-user"></i>
                        ...
                        <button class="change-avatar-btn" onclick="document.getElementById('avatarInput').click()">Change Avatar</button>
                    </div>
                ...
                <nav class="profile-nav">
                    ...
                    <a href="?tab=coupons" class="<?php echo $active_tab == 'coupons' ? 'active' : ''; ?>">
                        <i class="fa fa-tag"></i> Discount Codes
                    </a>
                </nav>
            </div>
