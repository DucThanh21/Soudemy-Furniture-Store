...
$pageTitle = "Shopping Cart - Soudemy";
...
if (!isset($_SESSION['user_id'])) {
    echo '<div class="container">
            <div class="alert alert-warning">
                <p>Please <a href="login.php" class="alert-link">log in</a> to view your shopping cart.</p>
            </div>
            ...
            <div class="cart-layout">
                ...
                <div class="summary-row discount-row">
                    <div class="coupon-section">
                        <input type="text" id="couponCode" placeholder="Enter discount code">
                        <button id="applyCoupon" class="btn btn-outline">Apply</button>
                    </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function applyCoupon() {
        ...
        const validCoupons = {
            ...
            'FREESHIP': 0,       // Free shipping (reduce $0 but can handle separately)
        ...
        setTimeout(() => {
            if (validCoupons.hasOwnProperty(couponCode.toUpperCase())) {
                ...
                // Change coupon section interface
                couponSection.innerHTML = `
                    <span style="color: #28a745; font-weight: bold;">${couponCode.toUpperCase()}</span>
                    <button id="removeCoupon" class="btn btn-outline" style="margin-left: 10px;">Remove</button>
                `;
                ...
                showMessage('Invalid or expired discount code!', 'error');
    ...
    function checkout() {
        ...
        checkoutBtn.innerHTML = '<i class="fa fa-spinner fa-spin"></i> Processing...';
