    ...
    <div class="container header-inner">
        ...
        <nav class="main-nav">
            <ul>
                ...
                <?php if (!empty($_SESSION['user_id']) && ($user['role'] ?? '') === 'admin'): ?>
                    <li><a href="/Do_an/backend/manager.php">Admin Panel</a></li>
                <?php endif; ?>
            </ul>
        </nav>
        ...
        <?php if ($isLoggedIn): ?>
            <div class="nav-user">
                ...
                <a href="/Do_an/frontend/profile.php" class="btn btn-outline">Profile</a>
                <a href="/Do_an/frontend/logout.php" class="btn btn-primary">Logout</a>
            </div>
        <?php else: ?>
        ...
        <div class="header-actions">
            ...
            <div class="search-container">
                <button class="search-toggle" title="Search"><i class="fa fa-search"></i></button>
...
<div id="loginModal" class="modal">
    <div class="modal-content">
        ...
        <h3>Login</h3>
        <div id="loginError" style="color:#000; display:none; margin-bottom:15px; padding:10px; background:#f8d7da; border-radius:4px; border:1px solid #f5c6cb;"></div>
        ...
        <form id="loginForm">
            ...
            <div style="text-align:center; font-size:13px; color:#666; margin-top:10px;">
                Don't have an account? <a href="/Do_an/frontend/register.php" style="color:#007bff; text-decoration:none;">Sign up now</a>
            </div>
        </form>
    </div>
</div>
